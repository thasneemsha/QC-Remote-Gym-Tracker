...
## FR-5: Coach Features (Expanded)

- **FR5.1** System shall allow coaches to log in with coach-level credentials.
- **FR5.2** System shall allow coaches to view their assigned users.
- **FR5.3** System shall allow coaches to retrieve user workout history.
- **FR5.4** System shall allow coaches to enter written feedback for a user.
- **FR5.5** System shall validate feedback inputs.
- **FR5.6** System shall store feedback linked to the selected user.
- **FR5.7** System shall allow coaches to update existing feedback.
- **FR5.8** System shall allow coaches to delete outdated feedback.
- **FR5.9** System shall notify users of new coach feedback (optional).
- **FR5.10** System shall display historical feedback to the user.
