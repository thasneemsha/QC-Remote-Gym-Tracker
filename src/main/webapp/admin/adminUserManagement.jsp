...
<head>
    <meta charset="UTF-8">
    <title>User &amp; Coach Management · QFit Admin</title>
    ...
    <header class="qfit-header">
        <div class="qfit-logo-group">
            ...
            <div class="qfit-title-block">
                ...
                <p class="qfit-subtitle">Review pending accounts and manage active users &amp; coaches</p>
            </div>
        </div>
    </header>
        ...
        <section class="qfit-glass-card qfit-admin-manage-card">
            ...
            <div class="qfit-admin-header-row qfit-admin-manage-header">
                <div class="qfit-admin-breadcrumb">
                    ...
                    <span>›</span>
                    <span>User &amp; Coach Management</span>
                </div>
                <button type="button"
            ...
            <div class="qfit-admin-filter-row">
                <div class="qfit-admin-toggle-group">
                    ...
                    <!-- ✅ Add navigation to All Accounts page -->
                    <button type="button"
            ...
            <div class="qfit-admin-table-section">
                <h2 class="qfit-admin-heading">Pending Coach Accounts</h2>
                <p class="qfit-admin-subtext">
                    Confirm that coach applications are valid and aligned with your program before granting access.
                </p>
            ...
            <div class="qfit-note qfit-note-small qfit-admin-info-note">
                ...
                this page will display real pending users and coaches from the database,
